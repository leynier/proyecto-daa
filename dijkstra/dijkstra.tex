...
\lstinputlisting[language=Python]{dijkstra_code_initialize_single_source.py}
...
\lstinputlisting[language=Python]{dijkstra_code_relax.py}
...
\lstinputlisting[language=Python]{dijkstra_code.py}
